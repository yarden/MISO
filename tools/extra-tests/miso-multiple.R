...
mres <- MISO(gene, reads=reads, noIterations=50000, noBurnIn=25000, noLag=100)
mres2 <- MISO(gene, reads=reads, noChains=5, noIterations=10000,
              noBurnIn=5000, noLag=100)
...
mres3 <- MISO(gene3, reads=reads3, noIterations=50000,
              noBurnIn=25000, noLag=100)
mres32 <- MISO(gene3, reads=reads3, noChains=5, noIterations=20000,
              noBurnIn=15000, noLag=100)
...
mresx2 <- MISO(gene2, reads=reads2, noIterations=50000,
               noBurnIn=25000, noLag=100)
mresx22 <- MISO(gene2, reads=reads2, noChains=5, noIterations=20000,
                noBurnIn=15000, noLag=100)
