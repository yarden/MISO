...
* MISO version 0.5.4 (`misopy-0.5.4.tar.gz`_), July 20, 2017 release (**Most recent**)
* MISO version 0.5.3 (`misopy-0.5.3.tar.gz`_), March 10, 2015 release 
...
.. _misopy-0.5.4.tar.gz: http://pypi.python.org/packages/source/m/misopy/misopy-0.5.4.tar.gz
