...
* MISO version 0.5.1 (`misopy-0.5.1.tar.gz`_), February 23, 2014 release (**Latest version**)
...
For example, to run on a single-end sample: ::
  ...
  miso --compute-genes-psi mm9/pickled/SE data/my_sample.sorted.bam --output-dir my_sample_output/ --read-len 35 
