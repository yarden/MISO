...
#      license = 'MIT License',
      ...
      data_files = [('misopy/settings', ['misopy/settings/miso_settings.txt',
                    ...
                    ('misopy/test-data/sam-data', ['misopy/test-data/sam-data/c2c12.Atp2b1.sam']),
                    ('misopy/gff-events/mm9', ['misopy/gff-events/mm9/SE.mm9.gff']),
                    ('misopy/gff-events/mm9/genes', ['misopy/gff-events/mm9/genes/Atp2b1.mm9.gff']),
