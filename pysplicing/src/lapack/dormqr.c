...
/* Subroutine */ int splicingdormqr_(char *side, char *trans, integer *m, integer *n, 
	...
	c__, integer *ldc, doublereal *work, integer *lwork, integer *info)
{
    ...
    extern /* Subroutine */ int splicingdorm2r_(char *, char *, integer *, integer *, 
...
/*        Determine the block size.  NB may be at most NBMAX, where NBMAX   
   ...
   Writing concatenation */
	...
	i__1 = 64, i__2 = splicingilaenv_(&c__1, "DORMQR", ch__1, m, n, k, &c_n1, (
		ftnlen)6, (ftnlen)2);
	nb = min(i__1,i__2);
	lwkopt = max(1,nw) * nb;
    ...
    if (*info != 0) {
	i__1 = -(*info);
	splicingxerbla_("DORMQR", &i__1, (ftnlen)6);
	return 0;
    } else if (lquery) {
	return 0;
    }
...
/* Computing MAX   
   Writing concatenation */
	    ...
	    i__3[1] = 1, a__1[1] = trans;
	    s_cat(ch__1, a__1, i__3, &c__2, (ftnlen)2);
	    i__1 = 2, i__2 = splicingilaenv_(&c__2, "DORMQR", ch__1, m, n, k, &c_n1, (
		    ftnlen)6, (ftnlen)2);
	    nbmin = max(i__1,i__2);
	}
    } else {
...
/*        Use unblocked code */
	...
	splicingdorm2r_(side, trans, m, n, k, &a[a_offset], lda, &tau[1], &c__[
...
/*           Form the triangular factor of the block reflector   
	    ...
	    i__4 = nq - i__ + 1;
	    splicingdlarft_("Forward", "Columnwise", &i__4, &ib, &a[i__ + i__ * 
...
/*           Apply H or H**T */
	    ...
	    splicingdlarfb_(side, trans, "Forward", "Columnwise", &mi, &ni, &ib, &a[
