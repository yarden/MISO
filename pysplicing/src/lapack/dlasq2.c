...
/* Subroutine */ int splicingdlasq2_(integer *n, doublereal *z__, integer *info)
{
    ...
    extern /* Subroutine */ int splicingdlasq3_(integer *, integer *, doublereal *, 
    ...
    extern /* Subroutine */ int splicingdlasrt_(char *, integer *, doublereal *, 
	    integer *);
...
/* Computing 2nd power */
    ...
    if (*n < 0) {
	*info = -1;
	splicingxerbla_("DLASQ2", &c__1, (ftnlen)6);
	return 0;
    } else if (*n == 0) {
	return 0;
    } else if (*n == 1) {
...
/*        1-by-1 case. */
	...
	if (z__[1] < 0.) {
	    *info = -201;
	    splicingxerbla_("DLASQ2", &c__2, (ftnlen)6);
	}
	return 0;
    } else if (*n == 2) {
...
/* L20: */
	...
	splicingdlasrt_("D", n, &z__[1], &iinfo);
	z__[(*n << 1) - 1] = d__;
	return 0;
    }
...
/*     Check whether the machine is IEEE conformable. */
    ...
    ieee = splicingilaenv_(&c__10, "DLASQ2", "N", &c__1, &c__2, &c__3, &c__4, (ftnlen)
	    6, (ftnlen)1) == 1 && splicingilaenv_(&c__11, "DLASQ2", "N", &c__1, &c__2,
...
/*           While submatrix unfinished take a good dqds step. */
	    ...
	    splicingdlasq3_(&i0, &n0, &z__[1], &pp, &dmin__, &sigma, &desig, &qmax, &
