...
/* Subroutine */ int splicingdlasd4_(integer *n, integer *i__, doublereal *d__, 
	...
	sigma, doublereal *work, integer *info)
{
    ...
    extern /* Subroutine */ int splicingdlaed6_(integer *, logical *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, integer *)
	    , splicingdlasd5_(integer *, doublereal *, doublereal *, doublereal *, 
...
/*        Presumably, I=1 upon entry */
	...
	*sigma = sqrt(d__[1] * d__[1] + *rho * z__[1] * z__[1]);
    ...
    if (*n == 2) {
	splicingdlasd5_(i__, &d__[1], &z__[1], &delta[1], rho, sigma, &work[1]);
	return 0;
    }
...
/*           Interpolation using THREE most relevant poles */
	    ...
	    dd[2] = dtiip;
	    splicingdlaed6_(&niter, &orgati, &c__, dd, zz, &w, &eta, info);
	    if (*info != 0) {
		goto L240;
	    }
	}
