...
/* Subroutine */ int splicingdlasrt_(char *id, integer *n, doublereal *d__, integer *
	info)
{
...
/*  -- LAPACK routine (version 3.2) --   
    ...
    *info = 0;
    dir = -1;
    if (splicinglsame_(id, "D")) {
	dir = 0;
    } else if (splicinglsame_(id, "I")) {
	dir = 1;
    }
    if (dir == -1) {
	*info = -1;
	...
	*info = -2;
    ...
    if (*info != 0) {
	i__1 = -(*info);
	splicingxerbla_("DLASRT", &i__1, (ftnlen)6);
	return 0;
    }
