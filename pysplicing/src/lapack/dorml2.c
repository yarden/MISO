...
/* Subroutine */ int splicingdorml2_(char *side, char *trans, integer *m, integer *n, 
...
/*     NQ is the order of Q */
	...
	*info = -10;
    ...
    if (*info != 0) {
	i__1 = -(*info);
	splicingxerbla_("DORML2", &i__1, (ftnlen)6);
	return 0;
    }
...
/*        Apply H(i) */
	...
	a[i__ + i__ * a_dim1] = 1.;
	splicingdlarf_(side, &mi, &ni, &a[i__ + i__ * a_dim1], lda, &tau[i__], &c__[
